...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='DIOR_in/10/train_task_1.json',
        data_prefix=dict(img='DIOR_image/'),
        start=start,
        end=end))
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='DIOR_in/10/test_task_1.json',
        data_prefix=dict(img='DIOR_image/'),
        start=start,
        end=end))
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'DIOR_in/10/test_task_1.json')
