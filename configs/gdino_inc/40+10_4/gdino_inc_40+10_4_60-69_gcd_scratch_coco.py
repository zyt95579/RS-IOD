...
load_from = './work_dirs/gdino_inc_40+10_4_50-59_gcd_scratch_coco/epoch_12.pth'
...
train_dataloader = dict(
    dataset=dict(
        type=dataset_type,
        ann_file='annotations/40+10_4/instances_train2017_60-69.json',
        setting='full_text',     
        start=start,
        end=end))
...
val_dataloader = dict(
    dataset=dict(
        ann_file='annotations/40+10_4/instances_val2017_0-69.json',
        setting='full_text',
        start=start,
        end=end)) 

val_evaluator = dict(ann_file=data_root + 'annotations/40+10_4/instances_val2017_0-69.json')
