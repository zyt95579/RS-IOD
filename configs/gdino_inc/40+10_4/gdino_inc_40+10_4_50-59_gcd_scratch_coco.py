...
train_dataloader = dict(
    dataset=dict(
        type=dataset_type,
        ann_file='annotations/40+10_4/instances_train2017_50-59.json',
        setting='full_text',     
        start=start,
        end=end))
...
val_dataloader = dict(
    dataset=dict(
        ann_file='annotations/40+10_4/instances_val2017_0-59.json',
        setting='full_text',
        start=start,
        end=end)) 

val_evaluator = dict(ann_file=data_root + 'annotations/40+10_4/instances_val2017_0-59.json')
